class Game(object):
	def __init__(self, level):
		...
		self.current_cursor_position = [0, 0]
	...
	def apply_move_given_direction(self, direction):
		new_position = [self.current_cursor_position[0] + direction[0], self.current_cursor_position[1] + direction[1]]

		self.apply_move_given_direction_and_new_pos(direction, new_position)
	...
	def apply_move_given_direction_and_new_pos(self, direction, new_pos):
		...
		self.current_cursor_position = new_pos
