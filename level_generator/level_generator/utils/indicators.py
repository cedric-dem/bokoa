...
def get_all_indicators(level):
	score_indicators = get_score_indicators(level)
	operations_used_indicator = get_operations_used_indicator(level)
	remaining_operations_indicator = get_remaining_operations_indicator(level)

	return score_indicators + [operations_used_indicator] + [remaining_operations_indicator]

def get_remaining_operations_indicator(level):
...
def get_operations_used_indicator(level):
...
def get_score_indicators(level):
	...
	return [proportion_increasing_steps, proportion_score_decreasing, lowest_score, solution_length, latest_negative_score_at]
